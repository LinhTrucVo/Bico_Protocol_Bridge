...
Req-I2CAPP-001: The component shall initialize the I2C master driver from ConfigService on startup.
   Verification: Init retrieves clock speed and configures the I2C master driver.

Req-I2CAPP-002: The component shall perform I2C write transactions to a target address.
   Verification: Write(addr, data, len) transmits data bytes to the I2C slave.

Req-I2CAPP-003: The component shall perform I2C read transactions from a target address.
   Verification: Read(addr, buffer, len) retrieves data bytes from the I2C slave.

Req-I2CAPP-004: The component shall return NACK status if the slave does not acknowledge.
   Verification: NACK from driver propagates as I2C_APP_STATUS_NACK.

Req-I2CAPP-005: The component shall return BUS_ERROR on I2C bus errors or timeout.
   Verification: Bus errors propagate as I2C_APP_STATUS_BUS_ERROR.

Req-I2CAPP-006: The component shall return INVALID_PARAM for null pointers or oversized transfers.
   Verification: Invalid inputs return error without hardware action.

Req-I2CAPP-007: The component shall return NOT_INITIALIZED if called before Init.
